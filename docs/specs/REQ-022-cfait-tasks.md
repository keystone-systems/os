...
**REQ-022.5** A new module `ks.systems/terminal/modules/terminal/tasks.nix` MUST be created
following the same pattern as `calendar.nix`.

**REQ-022.6** The module MUST expose options at `keystone.terminal.tasks`.

**REQ-022.7** The module MUST be imported by `ks.systems/terminal/modules/terminal/default.nix`.
